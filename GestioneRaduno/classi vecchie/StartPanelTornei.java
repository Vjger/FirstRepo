...
public class StartPanelTornei extends JFrame implements ActionListener {
	...
	private JSlider numeroTurno = new JSlider(SwingConstants.HORIZONTAL,1,16,1);
	...
	public StartPanelTornei(){
		MyLogger.getLogger().entering("StartPanelTornei", "StartPanelTornei");
        ...
        numeroTurno.setMajorTickSpacing(15);
		...
		setVisible(true);
		 //setSize(95,95);
		MyLogger.getLogger().exiting("StartPanelTornei", "StartPanelTornei");
	}
	...
	private void gestioneMenu(){
		...
		/* Gestione degli eventi sul menù About */
		 ActionListener listAbout = new ActionListener(){
			public void actionPerformed (ActionEvent e){
				JOptionPane.showMessageDialog(menuAbout,"GestioneRaduno 1.22 \n\n\n Sviluppato da Marco De Simone \n\n\n vjger69@gmail.com");
			}	
		 };
