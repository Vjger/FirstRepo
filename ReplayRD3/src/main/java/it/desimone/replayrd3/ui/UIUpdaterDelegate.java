package it.desimone.replayrd3.ui;
...
import it.desimone.replayrd3.Tabellone.TabellinoTerritorio;
...
import it.desimone.replayrd3.ui.panels.PlanciaPanel;
import it.desimone.replayrd3.ui.panels.PulsantieraPanel;
import it.desimone.replayrd3.ui.panels.StatePosition;
import it.desimone.replayrd3.ui.panels.StatsPanel;
...
public class UIUpdaterDelegate {
	...
	public void effettuaInvasione(Tabellone tabellone, Invasione invasione){
		...
		//Li aggiorno tutti perch� quando arrivo qui non so gi� pi� a chi apparteneva lo stato perso
		for (ColoreGiocatore giocatore: tabellone.getTabelliniGiocatori().keySet()){
			statsPanel.aggiornaTabellini(giocatore, tabellone.getTabellinoGiocatore(giocatore));
		}
		statsPanel.settaTimeELogId(tabellone.getTime(), tabellone.getLogId(), tabellone.getNumeroTurno());
