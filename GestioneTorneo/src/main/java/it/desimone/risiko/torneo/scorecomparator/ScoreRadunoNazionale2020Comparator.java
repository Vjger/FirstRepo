...
public class ScoreRadunoNazionale2020Comparator implements Comparator<ScorePlayer> {
	...
	public int compare(ScorePlayer sc1, ScorePlayer sc2) {
		int result = 0;
...
//			System.out.println("partite2: "+ArrayUtils.toString(partite2));
	...
	private List<BigDecimal> getPunteggiOrdinati(ScorePlayer scorePlayer){
